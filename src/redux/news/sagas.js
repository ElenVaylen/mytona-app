...
function* getNews(action) {
  try {
    ...
    const apiUrl = `https://newsapi.org/v2/everything?q=dark+souls+games+fantasy&language=en&page=${currentPage}&pageSize=${itemsPage}&apiKey=3439bdf38f944b5ca672b849c3415d76`
